        ...
        <div className="flex flex-col items-start">
          ...
          <div className="relative h-[6645px] self-stretch bg-black-900_2b">
            <div className="absolute bottom-[21%] right-[0.58px] m-auto flex w-[94%] flex-col items-start">
              <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
                ...
                <div className="flex w-[38%] flex-col items-start gap-1 rounded-[10px] bg-pink-A400_0f p-9 md:w-full md:p-5">
                  ...
                  <Text
                    size="3xl"
                    as="p"
                    className="ml-[47px] !text-pink-A400 md:ml-0"
                  >
                    100000+
                  </Text>
                  <Text
                    size="3xl"
                    as="p"
                    className="ml-[47px] !text-gray-700_01 md:ml-0"
                  >
                    Happy Customers
                  </Text>
                </div>
              ...
              <Heading
                as="h2"
                className="mt-[149px] self-center text-center !text-pink-A400"
              >
                Testimonials
              </Heading>
              <Text
                as="p"
                className="mt-2 w-[64%] self-center text-center !text-gray-700_01 md:w-full md:p-5"
              >
                Lorem ipsum dolor sit amet. Et accusamus necessitatibus eos
                ducimus optio aut tempora natus. 33 cupiditate quis et odit
                dignissimos et quaerat amet ut recusandae consequatur est{" "}
              </Text>
              <div className="mt-[60px] flex w-[93%] gap-[29px] md:w-full md:flex-col md:p-5">
                <div className="flex w-full flex-col items-start">
                  ...
                  <div className="relative mt-[-30px] h-[200px] self-stretch bg-white-A700 shadow-sm">
                    ...
                    >
                      Lorem ipsum dolor sit amet. Ex saepe fuga non porro autem
                      sit doloremque nulla ut aliquam dignissimos est corporis
                      laboriosam cum eaque autem! Et quia itaque ab omnis alias
                      id reprehenderit tempore vel labore amet ut Quis Quis in
                      nihil opt.
                    </Text>
                    <Img
            ...
            <div className="absolute right-[6%] top-[16%] m-auto flex w-[42%] flex-col items-start">
              ...
              <Heading
                as="h4"
                className="ml-0.5 mt-[3px] !text-gray-700_01 md:ml-0"
              >
              ...
              <Text as="p" className="mt-[18px] !text-gray-700_01">
                ...
                quae eum voluptatum nemo. Lorem ipsum dolor sit amet. Et
                accusamus necessitatibus eos ducimus optio aut tempora natus. 33
                cupiditate quis et odit dignissimos et quaerat amet ut
                recusandae consequatur est omnis quae eum voluptatum nemo.
              </Text>
              ...
              <div className="absolute left-0 right-0 top-[4%] m-auto flex w-[95%] items-start justify-between gap-5 md:relative md:flex-col">
                ...
                <div className="flex w-[72%] flex-col items-start md:w-full">
                  ...
                  <Text as="p" className="mt-[9px] !text-gray-700_01">
                    <>
                      Lorem ipsum dolor sit amet. Et accusamus necessitatibus
                      eos ducimus optio aut tempora natus. 33 cupiditate quis et
                      odit dignissimos et quaerat amet ut recusandae consequatur
                      est <br />
                      Lorem ipsum dolor sit amet. Et accusamus necessitatibus
                      eos ducimus optio aut tempora natus. 33 cupiditate quis et
                      odit dignissimos et quaerat amet ut recusandae consequatur
                      est omnis quae eum voluptatum nemo.Lorem ipsum dolor sit
                      amet. Et accusamus necessitatibus eos ducimus optio aut
                      tempora natus. 33 cupiditate quis et odit dignissimos et
                      quaerat amet ut recusandae consequatur est omnis quae eum
                      voluptatum nemo.Lorem ipsum dolor sit amet. Et accusamus
                      necessitatibus eos ducimus optio aut tempora natus. 33
                      cupiditate quis et odit dignissimos et quaerat amet ut
                ...
                <div className="flex items-center justify-between gap-5 md:flex-col">
                  <div className="relative h-[712px] w-[36%] md:h-auto md:w-full">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max w-full flex-col items-center justify-end rounded-bl rounded-tl bg-gradient3 p-[31px] sm:p-5">
                      <Heading
                        size="2xl"
                        as="h1"
                        className="mt-[549px] w-[87%] !font-lato leading-[50px] md:w-full"
                      >
                  ...
                  <div className="flex w-[59%] items-start justify-center gap-[11px] md:w-full md:flex-col">
                    <div className="mt-[47px] flex flex-1 flex-col items-start md:self-stretch">
                      <div className="flex justify-between gap-5 self-stretch md:flex-col">
                        ...
                        <div className="flex w-[43%] flex-col items-start md:w-full">
                          ...
                          <Input
                            shape="round"
                            name="email"
                            className="mt-2.5 self-stretch sm:px-5"
                          />
                          <Text
                            as="p"
                            className="mt-[52px] !text-blue_gray-900"
                          >
                            Employee Type
                          </Text>
                          <Input
                            shape="round"
                            name="edittext"
                            className="mt-[7px] self-stretch sm:px-5"
                          />
                        </div>
                      </div>
                      ...
                      <div className="mt-2.5 flex justify-between gap-5 self-stretch md:flex-col">
                        <Input
                          shape="round"
                          name="pincode"
                          className="w-[43%] md:w-full sm:px-5"
                        />
                        <Input
                          shape="round"
                          name="edittext_one"
                      ...
                      <Button
                        shape="round"
                        className="mt-[50px] min-w-[300px] font-lato font-medium sm:px-5"
                      >
                        Submit
                      </Button>
                    </div>
                    <Img
                      ...
                      alt="close_one"
                      className="h-[17px] w-[17px] md:w-full"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="absolute bottom-0 left-[6%] top-0 my-auto h-[152px] w-[48%]">
              <div className="absolute left-[0.00px] top-[0.00px] m-auto h-[144px] w-[64%] md:h-auto">
                ...
                <Heading
                  as="h4"
                  className="absolute bottom-[24%] left-[4.35px] m-auto text-center !text-pink-A400"
                >
                  What We’re Offering
                </Heading>
              </div>
              <Heading
                as="h4"
                className="absolute bottom-[-0.53px] left-0 right-0 m-auto w-max !text-gray-700_01"
              >
            ...
            <div className="absolute left-0 right-0 top-[11%] m-auto flex w-full max-w-[1042px] flex-col items-center md:p-5">
              ...
              <div className="relative mt-[-95px] flex flex-col items-center gap-[22px] self-stretch">
                ...
                <Text as="p" className="text-center !text-blue_gray-900">
                  ...
                  ducimus optio aut tempora natus. 33 cupiditate quis et odit
                  dignissimos et quaerat amet ut recusandae consequatur est
                  omnis quae eum voluptatum nemo.
                </Text>
              </div>
            </div>
            <div className="absolute left-0 right-0 top-1/4 m-auto flex w-full max-w-[1258px] flex-col items-start gap-[37px] md:p-5">
              <Heading as="h4" className="w-[72%] !text-pink-A400 md:w-full">
                ...
                <span className="text-gray_700">
                  EMI Calculator for Home Loan, Car Loan & Personal Loan in
                  India
                </span>
              </Heading>
              <div className="relative h-[1414px] self-stretch rounded-lg bg-[url(/public/images/img_group_35.svg)] bg-cover bg-no-repeat p-[23px] sm:p-5">
                ...
                <Text
                  as="p"
                  className="absolute left-[28.68px] top-[8%] m-auto !text-blue_gray-900"
                >
                  Home Loan Amount
                </Text>
                <Text
                  as="p"
                  className="absolute left-[28.68px] top-1/4 m-auto !text-blue_gray-900"
                >
                  Interest Rate
                </Text>
                <Text
                  as="p"
                  className="absolute left-[28.68px] top-[42%] m-auto !text-blue_gray-900"
                >
                  Loan Tenure
                </Text>
                <div className="absolute left-[19%] top-[8%] m-auto flex w-[17%] flex-col items-end">
                  ...
                  <Button className="relative mt-[-49px] min-w-[44px] rounded-br rounded-tr">
                    ₹
                  </Button>
                </div>
                <div className="absolute left-[19%] top-[24%] m-auto flex w-[17%] flex-col items-end">
                  <div className="flex self-stretch rounded border border-solid border-pink-A400 bg-pink-700_0f p-[11px]">
                    <Text
                      as="p"
                      className="ml-[13px] !text-blue_gray-900 md:ml-0"
                    >
                      9
                    </Text>
                  </div>
                ...
                <div className="absolute left-[19%] top-[41%] m-auto flex w-[21%] flex-col items-end">
                  <div className="flex items-center justify-between gap-5 self-stretch rounded border border-solid border-pink-A400 bg-pink-700_0f">
                    ...
                    <Button
                      color="pink_800"
                      className="min-w-[44px] rounded-br rounded-tr"
                    >
                      Mo
                    </Button>
                  </div>
                  <Button
                    shape="square"
                    className="relative mr-[45px] mt-[-49px] min-w-[44px] md:mr-0"
                  >
                    Yr
                  </Button>
                </div>
                ...
                <div className="absolute bottom-[7%] left-0 right-0 m-auto h-[548px] w-[97%] md:h-auto">
                      ...
                      <div className="flex w-[39%] items-start justify-between gap-5 sm:w-full">
                        <div className="mt-5 flex flex-col items-center">
                          ...
                          <Text
                            size="4xl"
                            as="p"
                            className="mt-[15px] !text-blue_gray-900"
                          >
                            ₹ 500000
                          </Text>
                          ...
                          <Text
                            size="4xl"
                            as="p"
                            className="mt-2.5 !text-blue_gray-900"
                          >
                            ₹ 500000
                          </Text>
                          <Text
                            as="p"
                            className="mt-[63px] text-center !text-blue_gray-900"
                          >
                            <>
                              Total Payment
                              <br />
                          ...
                          <Text
                            size="4xl"
                            as="p"
                            className="mt-[9px] !text-blue_gray-900"
                          >
                            ₹ 50,16,157
                          </Text>
                        </div>
                  ...
                  <div className="absolute right-[6%] top-[19%] m-auto flex h-[120px] w-[11%] items-center justify-center bg-[url(/public/images/img_group_38.svg)] bg-cover bg-no-repeat p-[34px] md:h-auto sm:p-5">
                    <Text
                      as="p"
                      className="rotate-[-61deg] self-end !text-blue-600"
                    >
                      45%
                    </Text>
                  </div>
                ...
                <div className="flex w-[49%] flex-wrap justify-between gap-5 md:w-full">
                  ...
                  >
                    <Text
                      size="lg"
                      as="p"
                      className="!font-lato !text-pink-A400"
                    >
                      Home
                    </Text>
                  </a>
                              ...
                              <div className="relative h-[598px] w-[88%] md:w-full">
                                ...
                                <div className="absolute left-0 right-0 top-[31%] m-auto flex w-full flex-col gap-[17px]">
                                  <Heading size="3xl" as="h1">
                                    Unlock Your Financial Potential: Explore Our
                                    Loan Services Today!
                                  </Heading>
                                  <Text
                                    size="2xl"
                                  ...
                                  >
                                    We make it easy for you to secure the ideal
                                    loan from India&#39;s premier lenders
                                    effortlessly.
                                  </Text>
                                </div>
                                <Button
            ...
            <div className="absolute bottom-[40%] left-0 right-0 m-auto flex w-full max-w-[1151px] gap-[49px] md:relative md:flex-col md:p-5">
              <div className="relative mb-0.5 h-[502px] w-full bg-blue_gray-100_01 md:mb-0">
                ...
                <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max w-full flex-col items-start justify-end bg-gradient1 p-[31px] sm:p-5">
                  <Heading
                    as="h4"
                    className="mb-[18px] mt-[390px] !font-montserrat"
                  >
                    Home Loan
                  </Heading>
                </div>
              ...
              <div className="relative h-[502px] w-full md:h-auto">
                ...
                <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max w-full flex-col items-start justify-end bg-gradient1 p-8 sm:p-5">
                  <Heading
                    as="h4"
                    className="mb-[18px] mt-[389px] !font-montserrat"
                  >
                    Credit Card
                  </Heading>
                </div>
