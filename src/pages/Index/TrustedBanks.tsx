...
export default function TrustedBanks() {
  return (
    <div className="flex items-center justify-between md:flex-col sm:flex-col">
      <div className="flex w-[90%] flex-col items-start gap-[29px] ml-20 md:w-[95%] md:p-5 sm:w-full">
        ...
        <div className="grid grid-flow-col w-full h-[30%] md:w-[90%] place-content-stretch md:place-content-evenly sm:grid-cols-2 sm:grid-flow-row sm:place-items-center sm:gap-5 sm:w-[80%]">
